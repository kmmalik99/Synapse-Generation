...
export const WandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.475 2.118A2.25 2.25 0 0 1 .879 16.5a3 3 0 0 1 4.292-2.752 3 3 0 0 0 4.354-2.222 3 3 0 0 0-.214-2.923l2.12-2.12a1.5 1.5 0 0 1 2.121 0l2.829 2.828a1.5 1.5 0 0 1 0 2.121l-2.122 2.121a3 3 0 0 0-2.922.215 3 3 0 0 0-2.222 4.354 3 3 0 0 1-2.752 4.292 2.25 2.25 0 0 1-2.118-2.475 3 3 0 0 0 1.128-5.78Z" />
  </svg>
);
...
export const FilmIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75v3.75a1.5 1.5 0 0 0 1.5 1.5h16.5a1.5 1.5 0 0 0 1.5-1.5v-3.75m-19.5-9v3.75a1.5 1.5 0 0 0 1.5 1.5h16.5a1.5 1.5 0 0 0 1.5-1.5v-3.75m-19.5 0A1.5 1.5 0 0 1 3.75 4.5h16.5a1.5 1.5 0 0 1 1.5 1.5m-19.5 0v.243a2.25 2.25 0 0 0 .58 1.536l1.29 1.29a2.25 2.25 0 0 0 1.588.657h12.084a2.25 2.25 0 0 0 1.588-.657l1.29-1.29a2.25 2.25 0 0 0 .58-1.536V6.75m-19.5 9v-.243a2.25 2.25 0 0 1 .58-1.536l1.29-1.29a2.25 2.25 0 0 1 1.588-.657h12.084a2.25 2.25 0 0 1 1.588.657l1.29 1.29a2.25 2.25 0 0 1 .58 1.536V15.75m-16.5-9h15" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.537a59.78 59.78 0 0 1-5.03,0l-3.722-.537A2.122 2.122 0 0 1 3 15.182V10.608c0-.97.616-1.813 1.5-2.097m16.5 0a2.121 2.121 0 0 0-1.5-2.097l-3.722-.537a59.78 59.78 0 0 0-5.03 0l-3.722.537a2.121 2.121 0 0 0-1.5 2.097m16.5 0-3.22-3.22m-13.28 3.22-3.22-3.22m10.222 6.442a3.75 3.75 0 0 1 4.5 0m-4.5 0a3.75 3.75 0 0 0-4.5 0" />
  </svg>
);
...
export const MicrophoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15a3 3 0 0 1-3-3V5.25a3 3 0 0 1 6 0v6.75a3 3 0 0 1-3 3Z" />
    </svg>
);
...
export const AIIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M13 15H15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M12 9V15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M17.202 10.798C17.695 11.291 18 11.921 18 12.585C18 13.963 16.963 15.085 15.585 15.085H15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M6.798 13.202C6.305 12.709 6 12.079 6 11.415C6 10.037 7.037 8.915 8.415 8.915H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export const VideoCameraSlashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="m15.75 10.5 4.72-4.72a.75.75 0 0 1 1.28.53v11.38a.75.75 0 0 1-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 0 0 2.25-2.25v-9A2.25 2.25 0 0 0 13.5 5.25h-9a2.25 2.25 0 0 0-2.25 2.25v9A2.25 2.25 0 0 0 4.5 18.75Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 19.5 4.5 4.5" />
    </svg>
);
...
export const ScissorsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 4.5 13.5 7.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 13.5 16.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 10.5 7.5 13.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5 16.5 13.5" />
    </svg>
);
...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571l6.19,5.238C39.902,35.61,44,29.932,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
);
